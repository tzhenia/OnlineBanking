...
<head>
    ...
    <title>О проекте | Online Banking</title>
            ...
            <div class="container">
                ...
                <div id="navbar" class="navbar-collapse collapse">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="active"><a href="/pages/about.jsp">О проекте</a></li>

                    </ul>
                    <ul class="nav navbar-nav navbar-right">
                        <li><a href="/pages/login.jsp">Вход</a></li>
                        <li><a href="/pages/registration.jsp">Регистрация</a></li>
