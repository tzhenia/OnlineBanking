...
-- for table card
  INSERT INTO card (id_user, number, id_card_type, card_name, balance, credit_limit, expiry_date, sum_of_credit, percent_value) values (1, 100000001, 1, "Card name 1", 10000, 0, "2019-05-01", 0, 35);
  INSERT INTO card (id_user, number, id_card_type, card_name, balance, credit_limit, expiry_date, sum_of_credit, percent_value) values (1, 100000002, 1, "Card name 2", 700.11, 1000, "2019-05-01", 0, 35);
  INSERT INTO card (id_user, number, id_card_type, card_name, balance, credit_limit, expiry_date, sum_of_credit, percent_value) values (1, 100000003, 2, "Card name - deposit", 2000, 0, "2019-05-01", 0, 20);
  INSERT INTO card (id_user, number, id_card_type, card_name, balance, credit_limit, expiry_date, sum_of_credit, percent_value) values (2, 100000004, 1, "Card name 1", 344.56, 0, "2019-08-01", 0, 35);
  INSERT INTO card (id_user, number, id_card_type, card_name, balance, credit_limit, expiry_date, sum_of_credit, percent_value) values (2, 100000005, 2, "Card name - deposit", 10000, 0, "2020-08-01", 0, 35);
  INSERT INTO card (id_user, number, id_card_type, card_name, balance, credit_limit, expiry_date, sum_of_credit, percent_value) values (3, 100000006, 1, "Card name 1", 10000, 0, "2021-04-01", 0, 35);
  INSERT INTO card (id_user, number, id_card_type, card_name, balance, credit_limit, expiry_date, sum_of_credit, percent_value) values (3, 100000007, 2, "Card name - deposit", 10000, 0, "2021-04-01", 0, 35);
